...
function normalizeImageMCP(raw, platform) {
  ...
  } else if (!blockingReasons.length || models.length || Object.keys(defaultModels).length) {
    throw capabilityError('capability_response_invalid', '已禁用的 image_mcp 能力缺少阻断原因或包含可执行模型。');
  }
  return {
    enabled: raw.enabled,
